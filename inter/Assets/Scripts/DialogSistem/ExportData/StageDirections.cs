...
namespace Graphene.ADInterpreter.ExportData{
    [Serializable] [XmlRoot(ElementName="StageDirections", Namespace="http://www.nevigo.com/schemas/articydraft/2.4/XmlContentExport_FullProject.xsd")]
    public class StageDirections {
