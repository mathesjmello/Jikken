...
{
    [Serializable] [XmlRoot(ElementName="TypedObjectTemplates", Namespace="http://www.nevigo.com/schemas/articydraft/2.4/XmlContentExport_FullProject.xsd")]
    public class TypedObjectTemplates {
